                    ...
                    for inscrit in inscrits:
                        ...
                        if inscriptions and (self.site is None or inscriptions[0].site == self.site):
                            ...
                            if inscrit.categorie:
                                ...
                                heures_realisees[nom] += facture.heures_realisees 
                                heures_facturees[nom] += facture.heures_facturees 
                            total_heures_realisees += facture.heures_realisees
                            total_heures_facturees += facture.heures_facture
