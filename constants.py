...
STATE_DEVIS_A_ENVOYER = 2
STATE_ATTENTE_REPONSE_PARENTS = 3
STATE_ACCORD_PARENTS = 4
STATE_REFUS_PARENTS = 5
STATE_EN_LISTE_ATTENTE = 6
STATE_DOSSIER_ACCEPTE = 7
STATE_DOSSIER_REFUSE = 8
