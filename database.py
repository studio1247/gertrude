...
class Activite(Base):
    ...
    def has_summary(self):
        return self.mode >= 0 and self.mode not in (MODE_CONGES, MODE_PLACE_SOUHAITEE, MODE_SYSTEMATIQUE_SANS_HORAIRES, MODE_SYSTEMATIQUE_SANS_HORAIRES_MENSUALISE, MODE_ABSENCE_NON_PREVENUE, MODE_SALARIE_HEURES_SUPP, MODE_SALARIE_RECUP_HEURES_SUPP)
