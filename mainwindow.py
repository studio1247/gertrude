...
class GertrudeFrame(wx.Frame):
    ...
    def OnAlertesAvailable(self, event):
        ...
        if result == wx.ID_NO:
            for date, message in event.new_alertes:
                ...
                database.creche.alertes[message] = alerte
            history.append(None)
    ...
    def OnAbout(self, event):
        ...
        info.Copyright = "(C) 2005-2020 Bertrand Songis"
        info.Description = wx.lib.wordwrap.wordwrap(
            ...
            "Développé pour une crèche parentale rennaise début 2005, il a été adapté à partir de 2007 pour d’autres crèches ; il est désormais accessible à tous.\n\n"
