...
class ParametersPanel(AutoTab):
    def __init__(self, parent):
        ...
        sizer.AddMany([(wx.StaticText(self, -1, u"Ordre des factures :"), 0, wx.RIGHT|wx.ALIGN_CENTER_VERTICAL, 10), (AutoChoiceCtrl(self, creche, 'tri_factures', [(u'Pas de tri', 0), ('Par nom', TRI_NOM), ('Par nom des parents', TRI_NOM_PARENTS)]), 0, wx.EXPAND)])
