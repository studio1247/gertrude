...
class SQLConnection(object):
    ...
    def Create(self, progress_handler=default_progress_handler):
        ...
        cur.execute("""
          CREATE TABLE CRECHE(
            ...
            regularisation_conges_non_pris BOOLEAN,
    ...
    def translate(self, progress_handler=default_progress_handler):
        ...
        if version < 112:
            cur.execute("ALTER TABLE CRECHE ADD siret VARCHAR;")
            cur.execute('UPDATE CRECHE SET siret=""')
